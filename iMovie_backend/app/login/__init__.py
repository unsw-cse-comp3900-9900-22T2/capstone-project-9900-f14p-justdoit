...
def init_route(app: Flask):
    ...
    app.add_url_rule('/app/movies/check_block', view_func=movies.check_block, methods=['POST'])
    ...
    app.add_url_rule('/app/movies/get_movielist_in_mdp', view_func=movies.get_movielist_in_mdp, methods=['POST'])
